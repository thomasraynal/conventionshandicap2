...
namespace ConventionsHandicap.EntityFramework.Migrations
{
    ...
    [Migration("20230723164241_seedWorkspace")]
    partial class seedWorkspace
    {
            ...
            modelBuilder.Entity("ConventionsHandicap.EntityFramework.ConventionsHandicapWorkspace", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("063412b6-69c8-41c0-ae73-fd1cc524d657"),
                            Name = "Cap Handi Cap"
                        });
                });
            ...
            modelBuilder.Entity("ConventionsHandicap.Model.ConventionsHandicapFeature", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("5e8e67e6-c218-45f3-b3ef-db2bfdab3975"),
            ...
            modelBuilder.Entity("ConventionsHandicapFeatureConventionsHandicapWorkspace", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            FeaturesId = new Guid("5e8e67e6-c218-45f3-b3ef-db2bfdab3975"),
                            WorkspacesId = new Guid("063412b6-69c8-41c0-ae73-fd1cc524d657")
                        });
                });
